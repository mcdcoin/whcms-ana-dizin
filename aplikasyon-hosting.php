<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Multi Platform Aplikasyon Hosting");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("aplikasyon-hosting.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("aplikasyon-hosting");
