<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Multi Platform Bayi Hosting");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("bayi-hosting.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("bayi-hosting");
