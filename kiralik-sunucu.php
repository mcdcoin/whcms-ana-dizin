<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Üst Seviye Kiralık Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("kiralik-sunucu.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("kiralik-sunucu");
