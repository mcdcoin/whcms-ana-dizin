<?php
	...
	** ****** *********************************** */
	...
	$ClientArea -> setPageTitle("Performanslı Sanal Sunucular");
	$ClientArea -> addToBreadCrumb("index.php", Lang::trans("globalsystemname"));
	$ClientArea -> addToBreadCrumb("sanal-sunucu.php", "İster Windows, İster Linux ihtiyacına uygun olanı seç.");
	...
	$ClientArea -> setTemplate("sanal-sunucu");
